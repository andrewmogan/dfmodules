/**
 * @file HDF5TriggerRecordReaderModule.hpp
 *
...
#ifndef DFMODULES_PLUGINS_HDF5TRIGGERRECORDREADER_HPP_
#define DFMODULES_PLUGINS_HDF5TRIGGERRECORDREADER_HPP_
...
/**
 * @brief HDF5TriggerRecordReaderModule is a shell for what we might write for the MiniDAQApp.
 */
class HDF5TriggerRecordReaderModule : public dunedaq::appfwk::DAQModule
{
public:
  /**
   * @brief HDF5TriggerRecordReaderModule Constructor
   * @param name Instance name for this HDF5TriggerRecordReaderModule instance
   */
  explicit HDF5TriggerRecordReaderModule(const std::string& name);

  HDF5TriggerRecordReaderModule(const HDF5TriggerRecordReaderModule&) = delete;            ///< HDF5TriggerRecordReaderModule is not copy-constructible
  HDF5TriggerRecordReaderModule& operator=(const HDF5TriggerRecordReaderModule&) = delete; ///< HDF5TriggerRecordReaderModule is not copy-assignable
  HDF5TriggerRecordReaderModule(HDF5TriggerRecordReaderModule&&) = delete;                 ///< HDF5TriggerRecordReaderModule is not move-constructible
  HDF5TriggerRecordReaderModule& operator=(HDF5TriggerRecordReaderModule&&) = delete;      ///< HDF5TriggerRecordReaderModule is not move-assignable
...
private:
  ...
  const appmodel::HDF5TriggerRecordReaderModuleConf* m_data_writer_conf;
...
ERS_DECLARE_ISSUE_BASE(dfmodules,
                       InvalidHDF5TriggerRecordReaderModule,
...
#endif // DFMODULES_PLUGINS_HDF5TRIGGERRECORDREADER_HPP_
